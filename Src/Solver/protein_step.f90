...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  integer (kind=4) , parameter :: nangles =6 !! the number of ligand angles we consider
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  real (kind=8), dimension(3), parameter :: kmod = (/ 0.01d0, 0.01d0, 1.0d0 /)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  integer*4 i,k,currentprotein,j1,j2, currentligand,aa,cnt,rnd  !! loop variables
  real (kind=8) :: angles(nangles)
  real*8 e, energies(2*nligands), etemp, xtemp(2*naa)
  real*8 lposy(nligands,nlinks_lig_aa),lposx(nligands,nlinks_lig_aa)  !! the vertical positions of the ligands
  ...
  do currentprotein=1,nproteins   !! loop over proteins
     ...
     do currentligand = 1, nligands  !! loop over ligands
        ...
        do currentangle = 1, nangles
           ...
           if ((currentligand /= 6) .or. (currentangle /= 5)) cycle
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
           ...
           do rnd = 1, 3
             ...
             aatable(1, 1) = kmod(rnd) * kww 
             aatable(1, 2) = kmod(rnd) * kw
             aatable(2, 1) = kmod(rnd) * kw
             aatable(2, 2) = kmod(rnd) * ks
  ...
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
             ...
             call aapolar2xy(xp, x0, y0, angles(currentangle), xf)
              ...
              write(45,'(i6,i2,i2,x,6(f6.3,x),x,16(i1),3(e18.10,x),26(f6.3,x))') &
